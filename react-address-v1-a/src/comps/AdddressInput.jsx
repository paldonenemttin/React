...
function AdddressInput(props) {

  const { addrList, setAddrList, setAddress, addr} = props
  const onChangeHandler = (e) => {
    ...
    setAddress({
      ...addr,
      u_id: addrList.length,
      u_name: e.target.value,
      u_addr: e.target.value,
      u_tel: e.target.value,
      u_age: e.target.value
    })
  };
  ...
  return (
    <div className="input_form">
      ...
      <button onClick ={addrInsert}>추가</button>
    </div>
  );
}
